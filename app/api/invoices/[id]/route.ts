...
async function handlePut(
  ...
  try {
    ...
    if (body.description !== undefined)
      sanitizedBody.description = body.description
    ...
    if (body.tenantId !== undefined)
      sanitizedBody.tenantId = body.tenantId ? sanitizeForDatabase(body.tenantId) : undefined;
    if (body.propertyId !== undefined)
      sanitizedBody.propertyId = body.propertyId ? sanitizeForDatabase(body.propertyId) : undefined;
    if (body.ownerId !== undefined)
      sanitizedBody.ownerId = body.ownerId ? sanitizeForDatabase(body.ownerId) : undefined;
    if (body.lineItems) sanitizedBody.lineItems = body.lineItems;
    if (body.notes !== undefined)
      sanitizedBody.notes = body.notes ? sanitizeForDatabase(body.notes) : undefined;
