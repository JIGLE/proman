...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    title: `${t("privacy")} — Lares`,
    description: "How Lares collects, uses, and protects your personal data.",
    robots: { index: false },
  };
}
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:py-24">
        ...
        <div className="space-y-10 text-[15px] leading-7">
          <section>
            ...
            <p>
              Lares (&ldquo;we&rdquo;, &ldquo;our&rdquo;, &ldquo;the platform&rdquo;) is committed
          ...
          <section>
            ...
            <ul className="ml-4 list-disc space-y-2 text-zinc-400">
              <li>To provide, maintain, and improve the Lares service.</li>
              <li>
          ...
          <section>
            ...
            <p className="text-zinc-400">
              Lares uses strictly necessary session cookies for authentication and CSRF protection.
