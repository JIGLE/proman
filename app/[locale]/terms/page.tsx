...
export async function generateMetadata({ params }: Props) {
  ...
  return {
    title: `${t("terms")} — Lares`,
    description: "Terms and conditions governing the use of Lares.",
    robots: { index: false },
  };
}
      ...
      <main className="mx-auto max-w-3xl px-4 py-16 sm:py-24">
        ...
        <div className="space-y-10 text-[15px] leading-7">
          <section>
            ...
            <p>
              By creating an account or using the Lares platform you agree to be bound by these
          ...
          <section>
            ...
            <p className="text-zinc-400">
              Lares is a property management platform designed to help landlords and property
          ...
          <section>
            ...
            <p className="mb-3 text-zinc-400">You must not use Lares to:</p>
            <ul className="ml-4 list-disc space-y-2 text-zinc-400">
          ...
          <section>
            ...
            <p className="text-zinc-400">
              To the maximum extent permitted by law, Lares&apos;s aggregate liability for any claim
              arising from or related to the service is limited to the fees you paid in the three
              months preceding the claim. We are not liable for indirect, incidental, special, or
              consequential damages, including loss of data or lost profits.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-zinc-400">
              The Lares platform and its source code (excluding third-party dependencies) are
        ...
        <div className="mt-16 border-t border-white/[0.06] pt-8">
          <Button variant="ghost" asChild className="text-zinc-500 hover:text-zinc-300">
            <Link href={`/${locale}`}>&larr; Back to Lares</Link>
          </Button>
        </div>
      </main>
    </div>
