        ...
        <div className="space-y-10 text-[15px] leading-7">
          ...
          <section>
            ...
            <p className="text-zinc-400">
              Situs is a property management platform designed to help landlords and property
          ...
          <section>
            ...
            <p className="mb-3 text-zinc-400">You must not use Situs to:</p>
            <ul className="ml-4 list-disc space-y-2 text-zinc-400">
          ...
          <section>
            ...
            <p className="text-zinc-400">
              To the maximum extent permitted by law, Situs&apos;s aggregate liability for any claim
          ...
          <section>
            ...
            <p className="text-zinc-400">
              The Situs platform and its source code (excluding third-party dependencies) are
