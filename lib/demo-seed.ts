...
export async function seedDemoData(userId: string): Promise<void> {
  ...
  await safeDelete(() => prisma.maintenanceTicket.deleteMany({ where: { userId } }), 'maintenanceTickets');
  await safeDelete(() => prisma.correspondence.deleteMany({ where: { userId } }), 'correspondence');
  await safeDelete(() => prisma.propertyOwner.deleteMany({ where: { property: { userId } } }), 'propertyOwners');
  ...
  const receiptsData = [
    ...
    { tenantIndex: 0, propertyIndex: 0, date: '2026-01-05', amount: 1500, type: 'rent' as ReceiptType },
    { tenantIndex: 0, propertyIndex: 0, date: '2026-02-05', amount: 1500, type: 'rent' as ReceiptType },
    { tenantIndex: 0, propertyIndex: 0, date: '2026-03-05', amount: 1500, type: 'rent' as ReceiptType },
    { tenantIndex: 0, propertyIndex: 0, date: '2026-04-05', amount: 1500, type: 'rent' as ReceiptType },
    { tenantIndex: 0, propertyIndex: 0, date: '2026-05-05', amount: 1500, type: 'rent' as ReceiptType },

    // Sophia Dubois (Jan - May 2026)
    { tenantIndex: 1, propertyIndex: 1, date: '2026-01-01', amount: 3200, type: 'rent' as ReceiptType },
    { tenantIndex: 1, propertyIndex: 1, date: '2026-02-01', amount: 3200, type: 'rent' as ReceiptType },
    { tenantIndex: 1, propertyIndex: 1, date: '2026-03-01', amount: 3200, type: 'rent' as ReceiptType },
    { tenantIndex: 1, propertyIndex: 1, date: '2026-04-01', amount: 3200, type: 'rent' as ReceiptType },
    { tenantIndex: 1, propertyIndex: 1, date: '2026-05-01', amount: 3200, type: 'rent' as ReceiptType },

    // Carlos Gómez (Jan - May 2026)
    { tenantIndex: 2, propertyIndex: 3, date: '2026-01-02', amount: 2200, type: 'rent' as ReceiptType },
    { tenantIndex: 2, propertyIndex: 3, date: '2026-02-02', amount: 2200, type: 'rent' as ReceiptType },
    { tenantIndex: 2, propertyIndex: 3, date: '2026-03-02', amount: 2200, type: 'rent' as ReceiptType },
    { tenantIndex: 2, propertyIndex: 3, date: '2026-04-02', amount: 2200, type: 'rent' as ReceiptType },
    { tenantIndex: 2, propertyIndex: 3, date: '2026-05-02', amount: 2200, type: 'rent' as ReceiptType }
  ];
  ...
  const expensesData = [
    { propertyIndex: 0, category: 'Repairs', amount: 450, date: '2026-02-12', description: 'Plumbing repair in Apartment 3A bathroom.' },
    { propertyIndex: 1, category: 'Insurance', amount: 980, date: '2026-01-15', description: 'Annual landlord building insurance package.' },
    { propertyIndex: 3, category: 'Maintenance', amount: 350, date: '2026-03-10', description: 'Air conditioning cleaning & filter swaps.' },
    { propertyIndex: 5, category: 'Taxes', amount: 1200, date: '2026-04-01', description: 'Madrid Local Property IBI Tax Payment.' },
    { propertyIndex: 0, category: 'Mortgage Interest', amount: 800, date: '2026-05-01', description: 'Monthly loan interest installment (Non-deductible category PT).' }
  ];
  ...
  const maintenanceData = [
    {
      ...
      description: 'Water dripping from the wall split AC unit during operation. Needs HVAC inspection.',
    ...
    },
    {
      ...
      description: 'Front door lock cylinder and handle are slightly loose. Hard to lock from inside.',
    ...
    },
    {
      ...
      description: 'Standard cosmetic wall prep and white painting layer for Apt 1B before renting.',
