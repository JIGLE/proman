    ...
    properties: [
      {
        ...
        property: { id: "demo-prop-1", name: "Sunset Apt. 2A" } as never,
      },
      {
        id: "demo-po-3",
        propertyId: "demo-prop-10",
        ...
        property: { id: "demo-prop-10", name: "Sunset Apt. 1B" } as never,
      },
      {
        id: "demo-po-5",
        propertyId: "demo-prop-2",
        ...
        property: { id: "demo-prop-2", name: "Downtown Office Suite" } as never,
      },
      {
        id: "demo-po-6",
        ...
        property: { id: "demo-prop-3", name: "Riverside House" } as never,
      },
      {
        id: "demo-po-7",
        propertyId: "demo-prop-4",
        ...
        property: { id: "demo-prop-4", name: "Marina View Condo" } as never,
      },
      {
        id: "demo-po-8",
        propertyId: "demo-prop-5",
        ...
        property: { id: "demo-prop-5", name: "Coimbra Student Flat" } as never,
      },
      {
        id: "demo-po-9",
        ...
        property: { id: "demo-prop-6", name: "Alfama Heritage Loft" } as never,
      },
    ],
  },
  {
    ...
    properties: [
      ...
      },
      {
        ...
        property: { id: "demo-prop-11", name: "Ribeira Flat No. 3" } as never,
      },
      {
        id: "demo-po-11",
        propertyId: "demo-prop-12",
        ownerId: "demo-owner-2",
        ownershipPercentage: 100,
        createdAt: "2024-09-05T00:00:00Z",
        updatedAt: "2024-09-05T00:00:00Z",
        property: { id: "demo-prop-12", name: "Ribeira Flat No. 4" } as never,
      },
      {
        id: "demo-po-12",
        propertyId: "demo-prop-7",
        ...
        property: { id: "demo-prop-7", name: "Eixample Apartment" } as never,
      },
      {
        id: "demo-po-13",
        propertyId: "demo-prop-8",
        ...
        property: { id: "demo-prop-8", name: "Chamberí Studio" } as never,
      },
      {
        id: "demo-po-14",
        propertyId: "demo-prop-9",
        ...
        property: { id: "demo-prop-9", name: "Valencia Office" } as never,
      },
    ],
  },
];
