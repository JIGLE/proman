...
| **Wrong dev-branch pointer** | `CLAUDE.md:76` → `claude/determined-clarke-swzwsz`; the live working branch is `claude/proman-design-polish-6zpz2f`                                                                                                                      | Point `CLAUDE.md` at the real branch                                             |
