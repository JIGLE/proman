...
export interface EnhancedInputProps extends Omit<
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex items-center gap-1">
            ...
            {hasError && !loading && <X className="w-4 h-4 text-destructive" />}

            {hasSuccess && !loading && !hasError && <Check className="w-4 h-4 text-green-500" />}
...
export interface EnhancedTextareaProps extends Omit<
        ...
        <div className="relative">
          ...
          {(hasError || hasSuccess) && (
            <div className="absolute right-3 top-3">
              {hasError && <X className="w-4 h-4 text-destructive" />}

              {hasSuccess && !hasError && <Check className="w-4 h-4 text-green-500" />}
            </div>
          )}
        </div>
