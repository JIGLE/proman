...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <DialogPortal>
      ...
      >
        {children}
        {/* Default, hidden description to satisfy Radix a11y check when a specific description is not provided. */}
...
const DialogHeader = ({
  ...
  <div className={cn("flex flex-col space-y-2 text-left pr-8", className)} {...props} />
);
