...
const nextActionStyles: Record<NextAction["urgency"], string> = {
  ...
  ok: "text-[var(--color-muted-foreground)] bg-transparent border-transparent",
};
    ...
    return (
      <>
                        ...
                        {buildingGroups.flatMap((group) => {
                          ...
                          const headerRow = showHeader ? (
                            ...
                            >
                              <TableCell
                                colSpan={7}
                                className="bg-[var(--color-surface-hover)] py-2 px-4"
                              >
                                ...
                                <DropdownMenu>
                                  <DropdownMenuTrigger asChild>
                                    <button
                                      ...
                                      className="rounded p-1.5 text-[var(--color-muted-foreground)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-foreground)] transition-colors"
                                    >
                                ...
                                {building.properties.map((property) => {
                                  ...
                                  return (
                                    <div
                                      key={property.id}
                                      className={cn(
                                        "flex items-center gap-3 px-4 py-3 transition-colors hover:bg-[var(--color-surface-hover)]",
                                    ...
                                    >
                                      ...
                                      {/* Type · bed · bath */}
                                      <div className="hidden shrink-0 flex-col items-end gap-0.5 text-xs text-[var(--color-muted-foreground)] xl:flex">
                                      ...
                                      <button
                                        ...
                                        onClick={(e) => {
                                          e.stopPropagation();
                                          if (isMissingMap) {
                                            formDialogRef.current?.openEditDialog(property);
                                          } else {
                                        ...
                                        className={cn(
                                          ...
                                          isMissingMap
                                            ? "text-[var(--color-warning)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-warning)]"
                                            : "text-[var(--color-muted-foreground)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-info)]",
                                        )}
                                      >
        ...
        <Dialog open={!!editingBuilding} onOpenChange={(open) => !open && setEditingBuilding(null)}>
          <DialogContent className="bg-[var(--color-card-solid)] border-[var(--color-border)] max-w-md">
            <DialogHeader>
